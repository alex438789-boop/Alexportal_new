...
export const mockAchievementCards: AchievementCardData[] = [
  {
    ...
    timeline: [
      {
        ...
        type: "Card created",
        description:
          "Created dissertation achievement card from LSE dissertation progress.",
        createdAt: "2026-07-07T17:42:00+08:00",
        newProgress: 58,
      },
    ],
    evidence: [
      ...
      },
      {
        ...
        description:
          "Mariah’s guidance to structure methodology around case selection, data, methods, and justification.",
        type: "note",
    ...
    timeline: [
      {
        ...
        type: "Card created",
        description:
          "Created product achievement card from YardenPORTAL prototype progress.",
        createdAt: "2026-07-07T17:45:00+08:00",
        newProgress: 75,
      },
    ],
  ...
  },
  {
    ...
    tags: ["CBAM", "Steel Industry", "Investment", "ESG", "EU Policy"],
    status: "Idea",
    progress: 28,
    currentValue:
    ...
    nextFillAction:
      "新增中鋼、台泥、亞泥近三年的營收與毛利率資料。",
    resumeBullet:
      "Developed an ESG investment research project analysing how EU CBAM regulation may affect Taiwan’s high-carbon industries through margin pressure and transition-risk channels.",
